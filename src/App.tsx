...
function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-secondary/30 selection:text-brand-primary">
      <Navbar />
      ...
      <section className="py-24 bg-brand-primary text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4">Words from Our Homeowners</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-2xl relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h5 className="font-bold">Andi & Sarah</h5>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-2xl relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h5 className="font-bold">Michelle T.</h5>
      ...
      {/* CTA Section */}
      <section id="contact" className="py-24 bg-brand-background relative">
        <div className="container mx-auto px-4 md:px-8">
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
              ...
              <p className="text-brand-text/70 mb-8">Book a free consultation or schedule a private viewing of our show units with our property advisors.</p>
              
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div>
                  <label className="block text-sm font-medium text-brand-text mb-1">Full Name</label>
                  <input type="text" className="w-full bg-brand-background border border-brand-accent/50 rounded-md px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-shadow" placeholder="John Doe" />
                </div>
                <div>
