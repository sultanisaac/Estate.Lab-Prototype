...
export function OverviewTab() {
  const stats = [
    { label: 'Total Bookings', value: mockBookings.length.toString(), icon: Calendar, color: 'bg-blue-100 text-blue-600' },
    { label: 'New Leads', value: mockLeads.length.toString(), icon: Users, color: 'bg-green-100 text-green-600' },
